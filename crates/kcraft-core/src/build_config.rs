...
impl Default for BuildConfig {
    fn default() -> Self {
        BuildConfig {
            ...
            launcher_domain: "kcraft.org".to_string(),
            launcher_config_file: "kcraft.cfg".to_string(),
            version_major: 1,
            version_minor: 4,
            version_channel: "develop".to_string(),
            updater_enabled: false,
            build_platform: Self::detect_platform(),
            user_agent: "KCraft/1.4".to_string(),
            user_agent_uncached: "KCraft/1.4".to_string(),
            meta_url: "https://meta.kcraft.org/v1/".to_string(),
            msa_client_id: String::new(),
            flame_api_key: String::new(),
            imgur_client_id: String::new(),
            news_rss_url: "https://kcraft.org/feed/feed.xml".to_string(),
            news_open_url: "https://kcraft.org/".to_string(),
            help_url: "https://kcraft.org/help".to_string(),
            bug_tracker_url: "https://github.com/KCraft/KCraft/issues".to_string(),
            translations_url: "https://hosted.weblate.org/projects/kcraft/kcraft/".to_string(),
            discord_url: "https://discord.gg/kcraft".to_string(),
            subreddit_url: "https://reddit.com/r/kcraft".to_string(),
            ...
            fmllibs_base_url: "https://files.kcraft.org/fmllibs/".to_string(),
